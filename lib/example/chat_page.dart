          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'Increasing cases for last 30 days',
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 32,
...
//      lineChartBarData3,
  ...
  List<String> getThreePoints(List list) {
    List<String> tempList = List();
    tempList.add(list[0].toString());
    tempList.add(list[(list.length / 2).round()].toString());
    tempList.add(list[list.length - 1].toString());
  }
}
